  ...
  return (
    <PageWrapper>
      ...
      <ul>
        <li>
          <p>
            ...
            downloaded by You on any electronic device, named Life Balancer
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Free Trial</strong> refers to a limited period of time that may be free when
        ...
        <li>
          <p>
            <strong>Subscriptions</strong> refer to the services or access to the Service offered on
      ...
      <p>
        ...
        will be billed in advance on a recurring and periodic basis (such as monthly or annually),
      ...
      <h2>Billing</h2>
      <p>You shall provide the Company with a valid payment method information.</p>
      <p>
      ...
      <h2>Refunds</h2>
      <p>
        You can read Refund policy{' '}
        <Link href="/about/refund" rel="external nofollow noopener" target="_blank">
          here
        </Link>
      </p>
      ...
      <h2>Free Trial</h2>
      <p>
        The Company may, at its sole discretion, offer a Subscription with a Free Trial for 14 days.
      </p>
      <p>
      ...
      <h1>Termination</h1>
      <p>
        We may terminate or suspend Your Account immediately if You breach these Terms and
        Conditions.
      </p>
      <p>
      ...
      <p>
        If You are a U.S. federal government end user, our Service is a &quot;Commercial Item&quot;
