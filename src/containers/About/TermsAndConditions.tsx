...
export const TermsAndConditions = () => {
  return (
    <div>
      ...
      <Typography>Welcome to lifebalancer.app!</Typography>

      <Typography>
        These terms and conditions outline the rules and regulations for the use of
        lifebalancer.app's Website, located at https://web.lifebalancer.app.
      </Typography>

      <Typography>
        By accessing this website we assume you accept these terms and conditions. Do not continue
        to use lifebalancer.app if you do not agree to take all of the terms and conditions stated
        on this page.
      </Typography>
      ...
      <Typography>
        We employ the use of cookies. By accessing lifebalancer.app, you agreed to use cookies in
        agreement with the lifebalancer.app's Privacy Policy.
      </Typography>
      ...
      <Typography>
        Unless otherwise stated, lifebalancer.app and/or its licensors own the intellectual property
        rights for all material on lifebalancer.app. All intellectual property rights are reserved.
        You may access this from lifebalancer.app for your own personal use subjected to
        restrictions set in these terms and conditions.
      </Typography>

      <Typography>You must not:</Typography>
      <ul>
        <li>Republish material from lifebalancer.app</li>
        <li>Sell, rent or sub-license material from lifebalancer.app</li>
        <li>Reproduce, duplicate or copy material from lifebalancer.app</li>
        <li>Redistribute content from lifebalancer.app</li>
      </ul>
      ...
      <Typography>
        ...
        information in certain areas of the website. lifebalancer.app does not filter, edit, publish
        or review Comments prior to their presence on the website. Comments do not reflect the views
        and opinions of lifebalancer.app,its agents and/or affiliates. Comments reflect the views
        and opinions of the person who post their views and opinions. To the extent permitted by
        applicable laws, lifebalancer.app shall not be liable for the Comments or for any liability,
        damages or expenses caused and/or suffered as a result of any use of and/or posting of
        and/or appearance of the Comments on this website.
      </Typography>

      <Typography>
        lifebalancer.app reserves the right to monitor all Comments and to remove any Comments which
      ...
      <Typography>
        You hereby grant lifebalancer.app a non-exclusive license to use, reproduce, edit and
      ...
      <Typography>
        ...
        visibility of the hyperlink compensates the absence of lifebalancer.app; and (d) the link is
      ...
      <Typography>
        ...
        linking to our website, you must inform us by sending an e-mail to lifebalancer.app. Please
      ...
      <Typography>
        No use of lifebalancer.app's logo or other artwork will be allowed for linking absent a
