...
export const PrivacyPolicy = () => {
  return (
    <PageWrapper>
      ...
      <Typography>
        At lifebalancer.app, accessible from https://web.lifebalancer.app, one of our main
        priorities is the privacy of our visitors. This Privacy Policy document contains types of
        information that is collected and recorded by lifebalancer.app and how we use it.
      </Typography>
      ...
      <Typography gutterBottom>
        ...
        website with regards to the information that they shared and/or collect in lifebalancer.app.
      ...
      <Typography>
        ...
        our Terms and Conditions, please visit the{' '}
        <Link href="/about/terms-and-conditions">Terms & Conditions page</Link>.
      </Typography>
      ...
      <Typography>
        lifebalancer.app follows a standard procedure of using log files. These files log visitors
      ...
      <Typography>
        Like any other website, lifebalancer.app uses 'cookies'. These cookies are used to store
      ...
      <Typography>
        ...
        lifebalancer.app, which are sent directly to users' browser. They automatically receive your
      ...
      <Typography>
        Note that lifebalancer.app has no access to or control over these cookies that are used by
      ...
      <Typography>
        lifebalancer.app's Privacy Policy does not apply to other advertisers or websites. Thus, we
      ...
      <Typography>
        lifebalancer.app does not knowingly collect any Personal Identifiable Information from
